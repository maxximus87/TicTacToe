...
get '/player_1_name' do
    erb :player_1_name, :layout => :layout, :locals => { :board => session[:board].board_positions }
end
...
post '/choose_opponent' do
	...
	if player_2 == "human"
		...
		erb :player_2_name, :layout => :layout, :locals => { :board => session[:board].board_positions }
...
get '/player_2_name' do
    erb :player_2_name, :layout => :layout, :locals => { :board => session[:board].board_positions, :player_2_name => session[:player_2_name] }
end
